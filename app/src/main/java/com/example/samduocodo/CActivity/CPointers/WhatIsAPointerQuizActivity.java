...
public class WhatIsAPointerQuizActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((TextView) findViewById(R.id.textViewCPointersQuizTitle)).setText((String) ("Question " + questionNum));
        ((TextView) findViewById(R.id.textViewCPointersQ)).setText(questionsArray[questionNum - 1]);
    }

    public void checkAnswer(View view) {
        view.setEnabled(false);
        findViewById(R.id.buttonCPointersQuizNext).setVisibility(View.VISIBLE);
        String answer = ((EditText) findViewById(R.id.editTextCPointersQuizAnswer)).getText().toString();
        TextView resultText = (TextView) findViewById(R.id.textViewCPointersQuizResult);
    ...
    public void loadNext(View view) {
        ...
        findViewById(R.id.buttonCPointersQuizCheck).setEnabled(true);
        if (questionNum > questionsArray.length) {
            Intent intent = new Intent(this, CPointersQuizResultActivity.class);
